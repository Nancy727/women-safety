      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-purple-900/20 backdrop-blur-sm rounded-lg border border-purple-800/40 p-6 shadow-lg">
              {isSubmitted ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-purple-200 mb-6">Your message has been sent successfully. We'll get back to you shortly.</p>
                  <button
                    onClick={() => setIsSubmitted(false)}
                    className="bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-white px-6 py-3 rounded-md font-medium shadow-lg transition-colors"
                  >
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                      ...
                      className={`w-full bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-white px-6 py-3 rounded-md font-medium shadow-lg transition-colors ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                    >
                      {isSubmitting ? (
        ...
        <section className="py-10 animate-fade-in-up" style={{ animationDelay: "0.5s" }}>
          <div className="bg-purple-900/20 backdrop-blur-sm rounded-lg border border-purple-800/40 p-6 shadow-lg">
            ...
            <div className="h-80 bg-purple-900/30 rounded-lg flex items-center justify-center">
